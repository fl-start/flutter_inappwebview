...
abstract mixin class LinuxStorage implements PlatformStorage {
  @override
  LinuxWebKitGtkInAppWebViewController? controller;
...
class LinuxLocalStorage extends PlatformLocalStorage with LinuxStorage {
  ...
  @override
  LinuxWebKitGtkInAppWebViewController? get controller =>
      params.controller as LinuxWebKitGtkInAppWebViewController?;
}
